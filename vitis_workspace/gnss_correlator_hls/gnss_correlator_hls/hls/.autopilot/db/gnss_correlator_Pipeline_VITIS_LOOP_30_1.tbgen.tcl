set moduleName gnss_correlator_Pipeline_VITIS_LOOP_30_1
set isTopModule 0
...
set cdfgNum 4
set C_modelName {gnss_correlator_Pipeline_VITIS_LOOP_30_1}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ gmem1 int 32 regular {axi_master 0}  }
	{ gmem0 int 32 regular {axi_master 0}  }
	{ num_samples int 32 regular  }
	{ sext_ln30 int 62 regular  }
	{ sext_ln30_1 int 62 regular  }
	{ sext_ln30_2 int 62 regular  }
	{ sext_ln30_3 int 62 regular  }
	{ acc_Q_out int 18 regular {pointer 1}  }
	{ acc_I_out int 18 regular {pointer 1}  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "code_I","offset": { "type": "dynamic","port_name": "code_I","bundle": "control_r"},"direction": "READONLY"},{"cName": "code_Q","offset": { "type": "dynamic","port_name": "code_Q","bundle": "control_r"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "signal_I","offset": { "type": "dynamic","port_name": "signal_I","bundle": "control_r"},"direction": "READONLY"},{"cName": "signal_Q","offset": { "type": "dynamic","port_name": "signal_Q","bundle": "control_r"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "num_samples", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "sext_ln30_3", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "acc_Q_out", "interface" : "wire", "bitwidth" : 18, "direction" : "WRITEONLY"} , 
 	{ "Name" : "acc_I_out", "interface" : "wire", "bitwidth" : 18, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ num_samples sc_in sc_lv 32 signal 2 } 
	{ sext_ln30 sc_in sc_lv 62 signal 3 } 
	{ sext_ln30_1 sc_in sc_lv 62 signal 4 } 
	{ sext_ln30_2 sc_in sc_lv 62 signal 5 } 
	{ sext_ln30_3 sc_in sc_lv 62 signal 6 } 
	{ acc_Q_out sc_out sc_lv 18 signal 7 } 
	{ acc_Q_out_ap_vld sc_out sc_logic 1 outvld 7 } 
	{ acc_I_out sc_out sc_lv 18 signal 8 } 
	{ acc_I_out_ap_vld sc_out sc_logic 1 outvld 8 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "num_samples", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "num_samples", "role": "default" }} , 
 	...
 	{ "name": "sext_ln30_3", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln30_3", "role": "default" }} , 
 	{ "name": "acc_Q_out", "direction": "out", "datatype": "sc_lv", "bitwidth":18, "type": "signal", "bundle":{"name": "acc_Q_out", "role": "default" }} , 
 	{ "name": "acc_Q_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "acc_Q_out", "role": "ap_vld" }} , 
 	{ "name": "acc_I_out", "direction": "out", "datatype": "sc_lv", "bitwidth":18, "type": "signal", "bundle":{"name": "acc_I_out", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	num_samples { ap_none {  { num_samples in_data 0 32 } } }
	...
	sext_ln30_3 { ap_none {  { sext_ln30_3 in_data 0 62 } } }
	acc_Q_out { ap_vld {  { acc_Q_out out_data 1 18 }  { acc_Q_out_ap_vld out_vld 1 1 } } }
	acc_I_out { ap_vld {  { acc_I_out out_data 1 18 }  { acc_I_out_ap_vld out_vld 1 1 } } }
}
